...
public class QuickStart {
    ...
    public void chapter1() {
        ...
        // HEX
        FieldTypeValue byteNumeric = FieldTypeValue.HEX;
        FieldTypeValue llvarByteNumeric = FieldTypeValue.LLVAR_HEX;
        FieldTypeValue lllvarByteNumeric = FieldTypeValue.LLLVAR_HEX;
        FieldTypeValue llllvarByteNumeric = FieldTypeValue.LLLLVAR_HEX;
    ...
    public Iso8583DataHeader newHeader() {
        //定义报文头数据格式
    ...
    public Iso8583MessageFactory newMessageFactory() {
        Iso8583MessageFactory facotry = new Iso8583MessageFactory(2, false, Charset.forName("UTF-8"), newHeader());
        facotry
                //使用默认填充策略
    ...
    public Iso8583Message newMessage() {
        Iso8583Message message = new Iso8583Message(newMessageFactory());
...
//		message.setValue(32, "0123456789");		// NullPointerException 没有对当前索引做配置
    ...
    public void chapter4_1() {
        ...
        facotry
                ...
                //1234506789
                .set(3, new Iso8583FieldType(Iso8583FieldType.FieldTypeValue.HEX, 5))
                ...
                //05 1234506789
                .set(6, new Iso8583FieldType(Iso8583FieldType.FieldTypeValue.LLVAR_HEX, 0))
                ...
                //0005 1234506789
                .set(9, new Iso8583FieldType(Iso8583FieldType.FieldTypeValue.LLLVAR_HEX, 0))
                ...
                //000005 1234506789
                .set(12, new Iso8583FieldType(Iso8583FieldType.FieldTypeValue.LLLLVAR_HEX, 0))
    ...
    public void chapter5() {
        Iso8583MessageFactory factory = newMessageFactory();
        Iso8583Message message = newMessage();

        System.out.println(EncodeUtil.bytes2Hex(message.getBytes()));
        System.out.println(message.getBytesString());
     ...
     */
    @Test
    public void chapter6() throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
        Iso8583MessageFactory factory = newMessageFactory();
        Iso8583Message message = newMessage();
