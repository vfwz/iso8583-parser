...
public class Iso8583FillBlankStrategy {
    ...
    // 默认右对齐，左补0的策略
    public static Iso8583FillBlankStrategy DEFAULT_LEFT_APPEND_STRATETY = leftAppendStrategy('0', false);

    // 默认左对齐，右补0的策略
    public static Iso8583FillBlankStrategy DEFAULT_RIGHT_APPEND_STRATETY = rightAppendStrategy('0', false);
